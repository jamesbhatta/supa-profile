<div class="p-5">
    ...
    <p class="text-justify">
        {{-- प्रस्तुत विषयमा {{ $organization->applicant_address }} नगरपालिका बस्ने श्री {{ $organization->prop_name }}को मिति {{ slashDateFormat($organization->applied_date) }} गतेका दिन दिनुभएको निवेदन अनुसारको व्यहोरा बुझ्दा {{ $organization->org_house_owner_name }}को नाममा दर्ता श्रेस्त कायम भएको हाल {{ $organization->municipality->name }} नं.पा. वडा नं. {{ $organization->ward->name }} अन्र्तगत पर्ने कि.नं. {{ $organization->org_land_kitta_no }}, {{ $organization->totalLandArea }} क्षेत्रफल भएको जग्गामा @if( $organization->applicant_name == $organization->prop_name) नीज @endif {{ $organization->prop_name }}ले {{ $organization->org_name }} नामक व्यवसाय संचालन गर्नको लागि सम्बन्धित निकायमा सिफारिस गरि पाउ भनि यस कार्यालयमा दर्ताका लागि दिएको निवेदन बमोजिन उक्त ब्वव्सयलाई दर्ता गरिदिनहुनका लागि सिफारिस साथ अनुरोध छ । --}}
