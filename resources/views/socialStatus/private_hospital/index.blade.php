    ...
    <div class="container-fluid">
        ...
        <div class="card z-depth-0">
            ...
            <div class="card-body">
                ...
                <form
                    action="{{ $privateHospital->id ? route('private-hospital.update', $privateHospital) : route('private-hospital.store') }}"
                    method="POST" class="form">
                    @csrf
                    @if ($privateHospital->id)
                        @method('put')
                    @endif
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <select name="district" id="select-district-id" class="custom-select">
                                @isset($privateHospital->id)
                                    <option value="{{ $privateHospital->district }}" selected>{{ $privateHospital ->district }}</option>
                                @else
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" id="input-fiscal-year" name="name" class="form-control font-roboto"
                                value="{{ old('name', $privateHospital->name) }}">
                        </div>
                    ...
                    <div class="form-group">
                        <button type="submit"
                            class="btn btn-success z-depth-0">{{ $privateHospital->id ? 'अपडेट गर्नुहोस्' : 'सेभ गर्नुहोस्' }}</button>
                    </div>
        ...
        <div class="card z-depth-0">
            ...
            <div class="card-body">
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        @forelse ($privateHospitals as $item)
                            <tr>
                                ...
                                <td>
                                    <a class="action-btn text-primary" href="{{ route('private-hospital.edit', $item) }}"><i
                                            class="far fa-edit"></i></a>
                                    <form action="{{ route('private-hospital.destroy', $item) }}" method="post"
