...
@section('content')
    <div class="container-fluid">
        <h3 class="font-weight-bold">दलित विद्यार्थीहरुको जिल्लागत संख्या विवरण</h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">सामाजिक विकास</li>
                <li class="breadcrumb-item active" aria-current="page">दलित विद्यार्थीहरुको जिल्लागत संख्या विवरण
                </li>
            </ol>
        </nav>
        <div class="container">
        ...
        <div class="card z-depth-0">
                ...
                <div style="overflow: auto;scrollbar-width: none;">
                    <div>
                        <nav class="nav nav-pills" id="pills-tab" role="tablist">
                            <h4>दलित विद्यार्थीहरुको जिल्लागत संख्या विवरण</h4>
                        </nav>
                    </div>
                </div>
            </div>
            <div class="card-body">
                ...
                <form
                    action="{{ $dalitStudent->id ? route('dalit-student.update', $dalitStudent) : route('dalit-student.store') }}"
                    ...
                    <div class="form-group">
                        ...
                        <select name="district" id="select-district-id" class="custom-select">
                            @isset($dalitStudent->id)
                                <option value="{{ $dalitStudent->district }}" selected>{{ $dalitStudent ->district }}</option>
                            @else
                    ...
                    <div class="row">
                        <div class="form-group col-lg-4">
                            ...
                            <select name="class" id="" class="custom-select">
                                @isset($dalitStudent->id)
                                    <option value="{{ $dalitStudent->class }}" selected>{{ $dalitStudent->class }}</option>
                                @else
                        ...
                        <div class="form-group col-lg-4">
                            ...
                            <input type="number" id="input-fiscal-year" name="female" class="form-control font-roboto"
                                value="{{ old('female', $dalitStudent->female) }}">
                        </div>
                        <div class="form-group col-lg-4">
                            ...
                            <input type="number" id="input-fiscal-year" name="male" class="form-control font-roboto"
                                value="{{ old('male', $dalitStudent->male) }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="submit"
                            class="btn btn-success z-depth-0">{{ $dalitStudent->id ? 'अपडेट गर्नुहोस्' : 'सेभ गर्नुहोस्' }}</button>
                    </div>
        ...
        <div class="card z-depth-0">
            <div class="card-header">
                <h1 class="h3-responsive d-inline-block">दलित विद्यार्थीहरुको जिल्लागत संख्या विवरण</h1>
                    ...
                    <tbody>
                        @forelse ($dalitStudents as $item)
                            <tr>
                                ...
                                <td>
                                    <a class="action-btn text-primary" href="{{ route('dalit-student.edit', $item) }}"><i
                                            class="far fa-edit"></i></a>
                                    <form action="{{ route('dalit-student.destroy', $item) }}" method="post"
