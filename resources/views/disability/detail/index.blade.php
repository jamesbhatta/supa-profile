...
<div class="container">
        ...
        <div class="card-body">
            <form action="{{route('disability-detail.store')}}" method="POST" class="form">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="input-name" name="male_num" class="form-control" autocomplete="off" value="{{ old('name') }}">
                </div>

                <div class="form-group">
                    <label for="input-name">अपाङ्ग महिला संख्या </label>
                    <input type="number" id="input-name" name="female_num" class="form-control" autocomplete="off" value="{{ old('name') }}">
                </div>
    ...
    <div class="card z-depth-0">
        <div class="card-header">
            ...
            <small>(हाल {{ count($disability_details)  }}  अपांगताको संख्यात्मक विवरण {{ count($disability_details) > 1 ? 'हरु छन्' : 'छ' }} )</small>
