...
@section('content')
    ...
    <div class="container">
        <div class="card z-depth-0">
            <div class="col-12">
                <label class="col-12 text-center font-weight-bold h4 my-5">भू – उपयोगको अवस्था</label>
                <hr>
            </div>
            <div class="card-body">
                <form
                    action="{{ $landUses->id ? route('land-uses.update',$landUses) : route('land-uses.store') }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="action-btn text-primary"
                                        href="{{ route('land-uses.edit', $item) }}"><i
