...
@section('content')
    ...
    <div class="container">
        <div class="card z-depth-0">
            <div class="col-12">
                <label class="col-12 text-center font-weight-bold h4 my-5">प्रदेशमा भू – स्वामित्वको अवस्था</label>
                <hr>
            </div>
            <div class="card-body">
                <form
                    action="{{ $ownership->id ? route('ownership.update',$ownership) : route('ownership.store') }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="action-btn text-primary"
                                        href="{{ route('ownership.edit', $item) }}"><i
