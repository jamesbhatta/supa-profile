    ...
    <div class="container">
            ...
            <div class="card-body">
                <form action="{{ $bali->id ? route('dalhan.update', $bali) : route('dalhan.store') }}" method="POST"
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="type" value="dalhan">
                    </div>
        ...
        <div class="card z-depth-0">
            <div class="card-header">
                <h1 class="h3-responsive d-inline-block">सुदूरपश्चिमका प्रमुख दलहन बालीको क्षेत्रफल, उत्पादन र उत्पादकत्व</h1>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="action-btn text-primary"
                                        href="{{ route('dalhan.edit', $item) }}"><i
                                            class="far fa-edit"></i></a>
                                    <form action="{{ route('dalhan.destroy', $item) }}" method="post"
