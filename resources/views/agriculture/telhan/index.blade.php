...
@section('content')
    ...
    <div class="container-fluid">
        <h3 class="font-weight-bold">सुदूरपश्चिमका प्रमुख तेलहन बालीको क्षेत्रफल, उत्पादन र उत्पादकत्व</h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">कृषि क्षेत्र</li>
                <li class="breadcrumb-item active" aria-current="page">सुदूरपश्चिमका प्रमुख तेलहन बालीको क्षेत्रफल, उत्पादन र उत्पादकत्व</li>
            </ol>
        </nav>
        <div class="container">
            @include('alerts.all')
        ...
        <div class="card z-depth-0">
                ...
                <div style="overflow: auto;scrollbar-width: none;">
                    <div>
                        <nav class="nav nav-pills" id="pills-tab" role="tablist">
                            <h4>सुदूरपश्चिमका प्रमुख तेलहन बालीको क्षेत्रफल, उत्पादन र उत्पादकत्व</h4>
                        </nav>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <form action="{{ $bali->id ? route('telhan.update', $bali) : route('telhan.store') }}" method="POST"
                    class="form">
                    @csrf
                    @isset($bali->id)
                        @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="type" value="telhan">
                    </div>
        ...
        <div class="card z-depth-0">
            <div class="card-header">
                <h1 class="h3-responsive d-inline-block">सुदूरपश्चिमका प्रमुख तेलहन बालीको क्षेत्रफल, उत्पादन र उत्पादकत्व
                </h1>
                    ...
                    <tbody>
                        @forelse ($balis as $item)
                            <tr>
                                ...
                                <td>
                                    <a class="action-btn text-primary" href="{{ route('telhan.edit', $item) }}"><i
                                            class="far fa-edit"></i></a>
                                    <form action="{{ route('telhan.destroy', $item) }}" method="post"
