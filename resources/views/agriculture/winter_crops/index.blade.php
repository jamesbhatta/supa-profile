...
@section('content')
    ...
    <div class="container">
        <div class="card z-depth-0">
            <div class="col-12">
                <label class="col-12 text-center font-weight-bold h4 my-5">सुदूरपश्चिमका प्रमुख हिउँदे बालीको क्षेत्रफल, उत्पादन र उत्पादकत्व</label>
                <hr>
            </div>
            <div class="card-body">
                <form action="{{ $bali->id ? route('winter-crop.update', $bali) : route('winter-crop.store') }}" method="POST"
                    class="form">
                    @csrf
                    @isset($bali->id)
                        @method('PUT')
        ...
        <div class="card z-depth-0">
            <div class="card-header">
                <h1 class="h3-responsive d-inline-block">सुदूरपश्चिमका प्रमुख हिउँदे बालीको क्षेत्रफल, उत्पादन र उत्पादकत्व</h1>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="action-btn text-primary"
                                        href="{{ route('winter-crop.edit', $item) }}"><i
