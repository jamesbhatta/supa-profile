    ...
    <div class="container-fluied">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" id="input-name" name="house_number" class="form-control"
                                autocomplete="off" value="{{ old('house_number') }}">
                        </div>
                        <div class="form-group col-md-4">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" id="input-name" name="female_number" class="form-control"
                                autocomplete="off" value="{{ old('female_number') }}">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="input-name">औषत घरपरिवार सदस्य संख्या</label>
                            <input type="texr" id="input-name" name="avg_house_number" class="form-control"
                                autocomplete="off" value="{{ old('avg_house_number') }}">
                        </div>
                        <div class="form-group col-md-4">
        ...
        <div class="card z-depth-0">
            <div class="card-header">
                ...
                <small>(हाल {{ count($population) }} स्थानिय तह को जनसंख्या विवरण
                    {{ count($population) > 1 ? 'हरु छन्' : 'छ' }} )</small>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="action-btn text-primary"
                                        href="{{ route('local-population.edit', $item->id) }}"><i
                                            class="far fa-edit"></i></a>
                                    <form action="{{ route('local-population.destroy', $item->id) }}" method="post"
