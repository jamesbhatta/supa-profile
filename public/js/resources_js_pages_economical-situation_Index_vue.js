...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    fetchEconomicIndicator: function fetchEconomicIndicator() {
      ...
      axios.get("/api/economic-indicator").then(function (response) {
        _this.provinceEconomicData.labels = response.data.labels;
        _this.provinceEconomicData.data = response.data.data;
        _this.infoDatas = response.data;
      })["catch"](function (error) {
        return console.log(error);
      });
    },
    fetchRevenueSharing: function fetchRevenueSharing() {
      var _this2 = this;

      axios.get("/api/revenue-sharing").then(function (response) {
        _this2.statusofRevenueSharing.labels = response.data.labels;
        _this2.statusofRevenueSharing.data = response.data.data;
        _this2.infoDatas = response.data;
      })["catch"](function (error) {
        return console.log(error);
      });
    },
    fetchRevenue: function fetchRevenue() {
      var _this3 = this;

      axios.get("/api/revenue").then(function (response) {
        _this3.RevenueReceivedState.labels = response.data.labels;
        _this3.RevenueReceivedState.data = response.data.data;
        _this3.infoDatas = response.data;
      })["catch"](function (error) {
        return console.log(error);
      });
    },
    fetchBudgetResource: function fetchBudgetResource() {
      var _this4 = this;

      axios.get("/api/budget-resource").then(function (response) {
        _this4.BudgetResourcesStatus.labels = response.data.labels;
        _this4.BudgetResourcesStatus.data = response.data.data;
    ...
    fetchTotalBudget: function fetchTotalBudget() {
      var _this5 = this;

      axios.get("/api/total-budget").then(function (response) {
        ...
        _c("div", { staticClass: "col-xl-8 col-lg-7 col-md-12" }, [
          _c(
            ...
            [
              ...
              _c(
                "data-viewer",
                { attrs: { data: _vm.BudgetResourcesStatus } },
                [
                  _c("template", { slot: "chart" }, [
                    _c("div", { staticClass: "row" }, [
                      _c(
                        ...
                        [
                          _c("pie-chart", {
                            attrs: {
                              "chart-data": _vm.BudgetResourcesStatusChartData,
                              width: 200,
                              height: 200,
                            },
                          }),
