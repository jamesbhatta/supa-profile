...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      infoCards: [],
      pieChartPlugins: [Object(function webpackMissingModule() { var e = new Error("Cannot find module 'chartjs-plugin-datalabels'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())],
      links: [{
        ...
        _c(
          ...
          [
            _c(
              ...
              [
                _c("i", {
                  staticClass: "fas fa-crown fa-3x text-warning my-3",
                }),
                _vm._v("\n        हालको मन्त्रिपरिषद्\n      "),
              ]
            ),
